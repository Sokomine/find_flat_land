...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	local heightmap2 = find_flat_land.visualize_extrema( heightmap, minp, maxp, heightmap, res, "wool:yellow","wool:orange");
	...
	heightmap2 = find_flat_land.visualize_extrema( heightmap2, minp, maxp, heightmap, res, "wool:magenta", "wool:cyan" );

	res = find_flat_land.detect_local_extrema( heightmap2, minp, maxp );
	-- turn layer two from valley bottoms into pink wool; turn mountain layers two below top into blue wool
	heightmap2 = find_flat_land.visualize_extrema( heightmap2, minp, maxp, heightmap, res, "wool:pink", "wool:blue" );
--[[
